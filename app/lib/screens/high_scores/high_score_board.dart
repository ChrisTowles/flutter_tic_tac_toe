                ...
                if (index == 0) {
                  return Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Expanded(flex: 2, child: _titleText('User')),
...
_buildDetailBox(ScoreDetail highScoreDetial) {
  TextStyle fontStyle = TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0);
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: <Widget>[
        Expanded(
          ...
          child: Row(
            children: <Widget>[
              CircleAvatar(
                child: Text(
                  highScoreDetial.user.name.substring(0, 1),
                ),
              ),
              SizedBox(
                width: 10.0,
        ...
        Expanded(
            child: Text(
          highScoreDetial.wins.toString(),
          style: fontStyle,
        )),
        Expanded(
            child: Text(
          highScoreDetial.losses.toString(),
          style: fontStyle,
        )),
        Expanded(
